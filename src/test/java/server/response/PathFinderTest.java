...
public class PathFinderTest {
    ...
    public void findsMatchingRouteForSimpleGetRequestAndGeneratesResponse() {
        ...
        pathFinder = new PathFinder(simpleGetRequest, app);
        Response simpleGetResponse = pathFinder.selectHandler();
    ...
    public void returnsNotFoundResponseForUnknownRoute() {
        ...
        pathFinder = new PathFinder(unknownRequest, app);
        Response unknownResponse = pathFinder.selectHandler();
    ...
    public void returnsMethodNotAllowedForRequestWithForbiddenMethod() {
        ...
        pathFinder = new PathFinder(wrongMethodRequest, app);
        Response unknownResponse = pathFinder.selectHandler();
